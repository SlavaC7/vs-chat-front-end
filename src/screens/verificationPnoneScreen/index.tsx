...
import { clearResulrAction, getMyProfileAction, sendVerifyCodeAction, sendVerifyPhoneCodeAction } from '../../store/profile/action';
...
const verificationPhoneScreen = () => {
  ...
  const [form,setForm]=useState({email:profile?.email,EnterEmail:false});
